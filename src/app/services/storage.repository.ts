...
import { IdentifiedEntityDefinition } from "../model/definitions/identified-entity.definition";
import { StorageServiceDefinition } from "./definition/storage.service.definition";

export class StorageRepository<T extends IdentifiedEntityDefinition<string>>  {
    storageName: string;
